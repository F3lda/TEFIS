...
$ResUpload = new ResumableLargeFilesUpload('TEFIS', './PRIVATE/'); // save files to private folder
...
// SHOW FILE
} else if(isset($_GET["SHOW"]) && isset($_GET["ID"]) && is_logged_in()){
...
<body>
    ...
    <?php
        ...
        // LARGE UPLOAD FILE
        } else if(isset($_GET["LARGE_UPLOAD"])){
    ...
    <div>
        ...
        // HOME PAGE
            ...
            */
            ...
            echo '<button onclick="window.location.href = \'./?LARGE_UPLOAD\';" style="font-weight: bold;">UPLOAD LARGE FILES</button><span> </span>';
