...
// -----------------------------
// maybe TODO - create dir, remove dir, move to dir, upload to dir; hash file number (file number+filename), files multi-selection
// -------------------------------------------------------------------------------------------------------------------------------------------------
			...
			function check_dir($dir){
				if(!file_exists($dir) && !is_dir($dir)) {
					...
					foreach($files as $id => $file) {
						...
						- <a class="abutton" title="Delete file" href="./?DELETE&DIR='.$dir.'&ID='.$id.'" onclick="return confirm(\'Really want to delete this file?\');">[X]</a>
						<br>';
					}
				}
			}
